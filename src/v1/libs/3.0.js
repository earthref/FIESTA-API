		...
		locations: {
			...
			columns: {
				...
				dir_tilt_correction: {
					...
					notes:
						'Correction between geographic (0%) and stratigraphic (100%); unoriented (-1%); partially oriented to horizontal only (-2%); unknown(-3%)',
		...
		sites: {
			...
			columns: {
				...
				result_type: {
					...
					unit: 'Flag',
					description:
						'(i) individual site value (an average of samples/specimens), (a) an average value over multiple places thought to be the same, (s) stacked: used for averages of multiple bore hole data, (m) model derived data. ',
					notes:
				...
				dir_tilt_correction: {
					...
					description: 'Percentage tilt correction applied to the data',
					notes:
						'use 0 for geographic directions and 100 for stratigraphically corrected directions; use values inbetween for partially corrected percent; unoriented (-1); partially oriented to horizontal only (-2); unknown(-3)',
		...
		samples: {
			...
			columns: {
				...
				dip: {
					...
					unit: 'Degrees',
					description:
						'Dip of sample’s X direction measured from the horizontal',
		...
		specimens: {
			...
			columns: {
				...
				dip: {
					...
					unit: 'Degrees',
					description:
						"Dip of specimen's X direction measured from the horizontal",
					validations: ['min(-90)', 'max(90)'],
					previous_columns: [
						{
							table: 'er_specimens',
