	...
	lab_protocol: {
		codes: [
			...
			},
			{
				code: 'LP-AN-DCP',
				definition:
					'Anisotropy measurement: ARM aquisition with a DC field for part of the aquisition',
				description:
			...
			},
			{
				code: 'LP-PI-CA-N',
				definition:
					'Paleointensity experiment in controlled atmosphere: Nitrogen',
			},
			{
				code: 'LP-PI-CA-VAC',
				definition:
					'Paleointensity experiment in controlled atmosphere: Under vacuum',
			},
			{
				code: 'LP-PI-CHEM',
